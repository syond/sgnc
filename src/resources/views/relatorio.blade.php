...
<script src="js/screenfull.js"></script>
  ...
  <!--banner-->	
		   <div class="banner">
				...
				<span>Relatório de Não Conformidade</span>
				</h2>
		    </div>
			<!----->
 ...
 <div class="form-group">
   ...
   <input type="text" class="form-control" id="razaoSocial" placeholder="Empresa de Ônibus.S/A">
 </div>
 ...
 <div class="form-group">
   ...
   <input type="text" class="form-control" id="técnico" >
 </div>

 <h2 align="center" >Não Conformidade</h2>
 
  <div class="form-group">
   <label for="nconformidade">Não Conformidade</label>
   
   <select class="form-control" >
      <option value="Não Conformidade" selected></option>
   </select>
 </div>
 ...
 <h2 align="center" >Ação Imediata</h2>
 ...
 <div class="form-group">
  ...
  <h2 align="center" >Ação Corretiva</h2>
 
 <div class="form-group">
   <label for="acaocorretiva">Ação Corretiva </label>
   <input type="text" class="form-control" id="acaocorretiva" >
 </div>
