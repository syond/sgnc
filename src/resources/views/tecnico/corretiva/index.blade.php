...
<table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $value->id }}</td>
            <td id="dados" data-toggle="modal" data-target="#exampleModal" data-imediata="{{ $value->imediata->id }}" data-setor="{{ $value->imediata->nao_conformidade->setor->nome }}" data-serial="{{ $value->imediata->nao_conformidade->equipamento->serial }}" data-onibus="{{ $value->imediata->nao_conformidade->equipamento->onibus->numero }}" data-descricao="{{ $value->descricao }}" data-data_de_criacao="{{ $value->created_at }}" data-nome="{{ $value->nome }}" data-id="{{ $value->id }}">{{ $value->nome }}</td>
